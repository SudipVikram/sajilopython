...
from tkinter import ttk, scrolledtext, filedialog, Menu, messagebox, simpledialog
import pygame
import threading
import re
import sys
...
class BobCharacter:
    def __init__(self):
        self.rect = pygame.Rect(275, HEIGHT - 70, 50, 50)  # Fixed position at bottom (subtract height)
    ...
    def update(self):
        ...
        if self.rect.bottom > HEIGHT - 10:  # 10px padding from bottom
...
def workbench():
    ...
    # Configure tab style for larger text
    style = ttk.Style()
