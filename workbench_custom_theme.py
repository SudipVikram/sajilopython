...
class AutoCompleteText(ctk.CTkTextbox):
    def __init__(self, *args, **kwargs):
        ...
        self._textbox.tag_configure = self._textbox.tag_config  # Alias for compatibility
...
def workbench():
    ...
    def add_new_tab(filename="Untitled", content=""):
        ...
        # Access the underlying Text widget for tag configuration
        text_widget = editor._textbox
    ...
    def open_settings():
        global editor_font_family, editor_font_size, editor_font_color, theme_mode, ctk_theme, settings_win
